...
export interface Detail { request_id: string; status?: string; original_text?: string; speech_text?: string; timing_ms?: Timing; audio?: AudioRecord; audio_id?: string; rewrite?: Record<string, unknown>; dictionary?: Record<string, unknown>; error?: unknown; [key: string]: unknown }
